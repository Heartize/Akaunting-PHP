...
<div class="dashboard-header">
    <div class="stat-card">
        ...
        <div class="stat-details">
            <div class="stat-value"><?php echo formatAmount($stats['income']); ?></div>
    ...
    <div class="stat-card">
        ...
        <div class="stat-details">
            <div class="stat-value"><?php echo formatAmount($stats['expense']); ?></div>
    ...
    <div class="stat-card">
        ...
        <div class="stat-details">
            <div class="stat-value"><?php echo formatAmount($stats['profit']); ?></div>
            <div class="stat-label">Beneficio (<?php echo number_format($stats['profit_percent'], 1); ?>%)</div>
        </div>
    </div>
    <div class="stat-card">
...
<div class="dashboard-cards">
    <div class="card">
        ...
        <div class="card-value"><?php echo formatAmount($stats['receivables']); ?></div>
    ...
    <div class="card">
        ...
        <div class="card-value"><?php echo formatAmount($stats['payables']); ?></div>
    ...
    <div class="card">
        ...
        <div class="card-subtitle"><?php echo $stats['low_stock_products']; ?> productos con bajo stock</div>
    </div>
</div>
